...
public class Brussel implements Serializable
{
    ...
    private final static long serialVersionUID = -535307568628556438L;
    ...
    public String toString() {
        ...
        sb.append(Brussel.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("to");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Brussel) == false) {
            return false;
        }
        Brussel rhs = ((Brussel) other);
